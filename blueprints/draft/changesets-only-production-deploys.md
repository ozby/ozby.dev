...
**Goal:** Changesets-only production deploys

## Planning Summary

- Goal input: `Changesets-only production deploys`
- Complexity: `M`
- Draft slug: `changesets-only-production-deploys`
- Output path: `blueprints/draft/changesets-only-production-deploys.md`
- Generated command: `wp blueprint new "Changesets-only production deploys" --complexity M`
